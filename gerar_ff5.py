...
"Proposto por Eugene Fama e Kenneth French (2015), o modelo FF5 expande o clássico CAPM acrescentando 4 fatores adicionais além do risco de mercado. ",
"É amplamente reconhecido na literatura acadêmica (Damodaran, Brigham — bibliografia do plano de ensino) como um dos frameworks mais robustos para explicar o retorno de ações em corte transversal.\n\n",
...
"Conectamos ao site Fundamentus e extraímos a tabela com todos os ativos listados na B3, incluindo métricas fundamentalistas prontas. ",
"Nenhuma ação é pré-selecionada manualmente — o modelo decide tudo.\n"]),
cell_code([
...
"O beta mede a sensibilidade do ativo às variações do mercado. Beta > 1 → mais volátil que o índice; Beta < 1 → mais defensivo. ",
"Para a competição (superar CDI), queremos betas moderados — volatilidade controlada.\n"]),
cell_code([
...
"Para cada fator, ranqueamos os ativos (ranking relativo 1 a N) e **invertemos** os fatores em que 'menor é melhor' (P/VP, Cresc. Receita). ",
"A soma dos 5 ranks gera o **Score FF5**: quanto menor, mais atrativo é o ativo segundo o modelo.\n"]),
cell_code([
...
"Com os 12 melhores ativos pelo modelo FF5, testamos **todas as 495 combinações únicas** de 4 ativos. ",
"Para cada combinação, o otimizador não-linear (SciPy/SLSQP) calcula os pesos que maximizam o **Índice de Sharpe** usando dados históricos de retorno e covariância (5 anos). ",
"A carteira vencedora é a que apresenta o maior Sharpe global.\n"]),
cell_code([
...
"O modelo Fama-French 5 Fatores é amplamente reconhecido na academia e perfeitamente alinhado ao conteúdo do **Módulo 04** da disciplina (Variáveis de Firma: ROE, ROA, EBITDA, P/L). ",
"Ao substituir a triagem subjetiva por um sistema de fatores quantificáveis e replicáveis, eliminamos o viés de seleção e garantimos uma metodologia auditável. ",
"A fusão com a otimização combinatória de Markowitz assegura que os **4 ativos** escolhidos são simultaneamente aqueles mais bem posicionados nos 5 fatores **e** a combinação que maximiza o prêmio de risco frente ao CDI.\n",
]),
]
...
out = r"c:\Users\User\Downloads\Competicao-de-Carteiras-2026---Analise-de-Investimento\Estrategia 1 - Fama-French 5 Fatores.ipynb"
